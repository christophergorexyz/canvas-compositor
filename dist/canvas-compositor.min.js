...
(() => {
  ...
  var _Vector = class _Vector extends Array {
    ...
    static scale(v, s) {
      v = v instanceof _Vector ? v : new _Vector(v);
    ...
    static cross(v1, v2) {
      return new _Vector([v1[1] * v2[2] - v1[2] * v2[1], v1[2] * v2[0] - v1[0] * v2[2], v1[0] * v2[1] - v1[1] * v2[0]]);
    }
    distance(v) {
  ...
  var Composition = class extends Component {
    /**
