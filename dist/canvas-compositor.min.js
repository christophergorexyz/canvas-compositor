...
(() => {
  ...
  var Composition = class _Composition extends Component {
    ...
    _updateBoundsForChildren() {
      ...
      for (const child of this.children) {
        ...
        const left = child.displacement[0] + childRenderOffset2[0];
        const top = child.displacement[1] + childRenderOffset2[1];
  ...
  // lib/index.ts
  globalThis.CanvasCompositor = { Compositor, Components2d: context_2d_exports, InteractionController, DebugOverlay };
})();
