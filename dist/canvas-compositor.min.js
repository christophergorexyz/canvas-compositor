...
(() => {
  ...
  var Composition = class _Composition extends Component {
    ...
    childrenAt(x, y) {
      return this.children.filter((child) => {
        ...
        localX = ux + pivot[0];
        localY = uy + pivot[1];
        return child.isPointInPath(child.path, localX, localY) || child.isPointInStroke(child.path, localX, localY);
      });
    }
    /**
  ...
  // lib/index.ts
  globalThis.CanvasCompositor = { Compositor, Components2d: context_2d_exports };
})();
